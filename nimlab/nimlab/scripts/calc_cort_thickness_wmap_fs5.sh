...
sub=$f1
    for hemi in lh rh; do
        ...
        mri_surf2surf --srcsubject $sub --srcsurfval $3/$sub/surf/$hemi.thickness --trgsubject fsaverage5 --trgsurfval $4/$hemi.${sub}_thickness.fs5.$fwhm.mgh --fwhm $fwhm --hemi $hemi
        if [[ $f2 == "Male" ]]; then
