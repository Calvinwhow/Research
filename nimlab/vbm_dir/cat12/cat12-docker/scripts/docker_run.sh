...
DOCKERFILE_PATH="vbm/cat12/cat12-docker/docker/Dockerfile"
...
# CAT12 script path
CAT12_SCRIPT_PATH="vbm/cat12/cat12-docker/scripts/cat_12_vbm.sh"

# FSLMATHS script path
FSLMATHS_SCRIPT_PATH="vbm/cat12/cat12-docker/scripts/fslmath_wm_gm_csf_tiv_correction.sh"
